...
class CreateOdrednicaSerializer(serializers.Serializer):
    ...
    opciono_se = serializers.BooleanField(required=False, allow_null=True)
    napomene = serializers.CharField(max_length=4000, required=False, allow_blank=True, allow_null=True)
    freetext = serializers.CharField(max_length=4000, required=False, allow_blank=True, allow_null=True)
