...
class VidPrideva(models.Model):
    ...
    mnomjed = models.CharField('мушки номинатив једнина', max_length=50, blank=True, null=True)
    mgenjed = models.CharField('мушки генитив једнина', max_length=50, blank=True, null=True)
    mdatjed = models.CharField('мушки датив једнина', max_length=50, blank=True, null=True)
    makujed = models.CharField('мушки акузатив једнина', max_length=50, blank=True, null=True)
    mvokjed = models.CharField('мушки вокатив једнина', max_length=50, blank=True, null=True)
    minsjed = models.CharField('мушки инструментал једнина', max_length=50, blank=True, null=True)
    mlokjed = models.CharField('мушки локатив једнина', max_length=50, blank=True, null=True)
    mnommno = models.CharField('мушки номинатив множина', max_length=50, blank=True, null=True)
    mgenmno = models.CharField('мушки генитив множина', max_length=50, blank=True, null=True)
    mdatmno = models.CharField('мушки датив множина', max_length=50, blank=True, null=True)
    makumno = models.CharField('мушки акузатив множина', max_length=50, blank=True, null=True)
    mvokmno = models.CharField('мушки вокатив множина', max_length=50, blank=True, null=True)
    minsmno = models.CharField('мушки инструментал множина', max_length=50, blank=True, null=True)
    mlokmno = models.CharField('мушки локатив множина', max_length=50, blank=True, null=True)
    znomjed = models.CharField('женски номинатив једнина', max_length=50, blank=True, null=True)
    zgenjed = models.CharField('женски генитив једнина', max_length=50, blank=True, null=True)
    zdatjed = models.CharField('женски датив једнина', max_length=50, blank=True, null=True)
    zakujed = models.CharField('женски акузатив једнина', max_length=50, blank=True, null=True)
    zvokjed = models.CharField('женски вокатив једнина', max_length=50, blank=True, null=True)
    zinsjed = models.CharField('женски инструментал једнина', max_length=50, blank=True, null=True)
    zlokjed = models.CharField('женски локатив једнина', max_length=50, blank=True, null=True)
    znommno = models.CharField('женски номинатив множина', max_length=50, blank=True, null=True)
    zgenmno = models.CharField('женски генитив множина', max_length=50, blank=True, null=True)
    zdatmno = models.CharField('женски датив множина', max_length=50, blank=True, null=True)
    zakumno = models.CharField('женски акузатив множина', max_length=50, blank=True, null=True)
    zvokmno = models.CharField('женски вокатив множина', max_length=50, blank=True, null=True)
    zinsmno = models.CharField('женски инструментал множина', max_length=50, blank=True, null=True)
    zlokmno = models.CharField('женски локатив множина', max_length=50, blank=True, null=True)
    snomjed = models.CharField('средњи номинатив једнина', max_length=50, blank=True, null=True)
    sgenjed = models.CharField('средњи генитив једнина', max_length=50, blank=True, null=True)
    sdatjed = models.CharField('средњи датив једнина', max_length=50, blank=True, null=True)
    sakujed = models.CharField('средњи акузатив једнина', max_length=50, blank=True, null=True)
    svokjed = models.CharField('средњи вокатив једнина', max_length=50, blank=True, null=True)
    sinsjed = models.CharField('средњи инструментал једнина', max_length=50, blank=True, null=True)
    slokjed = models.CharField('средњи локатив једнина', max_length=50, blank=True, null=True)
    snommno = models.CharField('средњи номинатив множина', max_length=50, blank=True, null=True)
    sgenmno = models.CharField('средњи генитив множина', max_length=50, blank=True, null=True)
    sdatmno = models.CharField('средњи датив множина', max_length=50, blank=True, null=True)
    sakumno = models.CharField('средњи акузатив множина', max_length=50, blank=True, null=True)
    svokmno = models.CharField('средњи вокатив множина', max_length=50, blank=True, null=True)
    sinsmno = models.CharField('средњи инструментал множина', max_length=50, blank=True, null=True)
    slokmno = models.CharField('средњи локатив множина', max_length=50, blank=True, null=True)
